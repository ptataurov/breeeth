...
const list = document.querySelector('.related-products__container-list')
const items = list.querySelectorAll('.related-products__list-item')
const btnPrev = document.querySelector(
  '.related-products__btn-prev:first-of-type'
)
const btnNext = document.querySelector(
  '.related-products__btn-next:last-of-type'
)

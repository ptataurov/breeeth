...
$(document).ready(function() {
  ...
  $('.reviews-slider__toggle-btn').on('click', function() {
    $(this)
      .find('.reviews-slider__toggle-btn-text')
      .toggle()

    $(this).toggleClass('reviews-slider__toggle-btn--active')
    $(this)
      .closest('.reviews-slider__body')
      .find('.reviews-slider__review-text')
      .toggleClass('reviews-slider__review-text--show')
  })
})
